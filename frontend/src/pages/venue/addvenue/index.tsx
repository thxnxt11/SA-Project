            ...
            <Row gutter={16}>
              ...
              <Col span={12}>
                <Form.Item
                  ...
                  name="venue_type_id"
                  rules={[
                    { required: true, message: "Please select venue type!" },
                  ]}
                >
                          ...
                          <Col span={12}>
                            <Form.Item
                              ...
                              rules={[
                                {
                                  required: true,
                                  message: "Please select stage type",
                                },
                              ]}
                            >
                                          ...
                                          rules={[
                                            ...
                                            ({ getFieldValue }) => ({
                                              validator(_, value) {
                                                ...
                                                if (
                                                  value >
                                                  eqObj.remaining_quantity
                                                )
                                                  return Promise.reject(
                                                    new Error(
                                                      `Exceeds remaining stock: ${eqObj.remaining_quantity}`
                                                    )
                                                  );
                                                return Promise.resolve();
                                              },
